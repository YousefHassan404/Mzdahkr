      ...
      >
        ...
        <div className="bg-gradient-to-r from-navy-900 to-navy-800 rounded-xl shadow-lg p-6 mb-8 text-white">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center">
            ...
            <div className="mt-4 md:mt-0 bg-orange-500 text-white px-6 py-2 rounded-full text-sm font-medium shadow-md">
              {remainingShares?.toLocaleString()} سهم متاح من{" "}
              {unit.noOfShares?.toLocaleString()}
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            {/* Property Details */}
            <section className="bg-white rounded-xl shadow-md p-6">
              <h2 className="text-xl font-semibold text-navy-800 mb-6 pb-2 border-b border-gray-200">
                تفاصيل الوحدة
              </h2>
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white rounded-xl shadow-md p-6">
              ...
              <div className="text-center p-4">
                ...
                <p className="text-sm text-gray-500">أسهم متاحة للاستثمار</p>
                <div className="mt-4 bg-gray-100 rounded-full h-2.5">
                  <div
                    className="bg-orange-600 h-2.5 rounded-full"
                    style={{
                      width: `${(remainingShares / unit.noOfShares) * 100}%`,
                    }}
                  ></div>
                </div>
                <p className="text-xs text-gray-500 mt-2">
                  {Math.round((remainingShares / unit.noOfShares) * 100)}%
                  متبقية
                </p>
              </div>
            </div>
                      ...
                      {unit.users.map((user, idx) => (
                        <tr key={idx}>
                          <td className="px-4 py-3 whitespace-nowrap text-sm text-navy-900">
                            المستخدم #{<UserName id={user.userId} />}
                          </td>

...
export default function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!result.success) {
      const firstError =
        result.error.errors[0]?.message || "حدث خطأ في البيانات.";
  ...
  return (
    <>
      <div className="min-h-screen flex flex-col relative mt-20">
        ...
        <main
          dir="rtl"
          className="flex-grow flex items-center justify-center pt-20 pb-10 px-4 relative z-10"
        >
          <div className="w-full max-w-md bg-white/90 backdrop-blur-sm rounded-xl shadow-2xl p-8 border border-white/20">
            ...
            <form className="space-y-4" onSubmit={handleSubmit}>
              ...
              <div dir="ltr">
                ...
                >
                  <option value="">اختار اهتمامك </option>
              ...
              {/* المنطقة المهتم بها */}
              <Input
                id="interstedLocation"
                type="text"
                handleChange={handleChange}
                value={data.interstedLocation}
                label="المنطقة المهتم بها"
